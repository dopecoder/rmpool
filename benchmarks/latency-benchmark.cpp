...
void bench_for_int(int num)
{
    ...
    // read time
    std::cout << "Read Time " << read_time.count() << " seconds.";
    // total time
    std::cout << "Total Time " << total_time.count() << " seconds.";
    // Avg read time / element
    std::cout << "Avg Read Time " << read_time.count() / num << " seconds.";
    // Avg write time / element
    std::cout << "Avg Write Time " << write_time.count() / num << " seconds.";
    // Avg total time / element
    std::cout << "Avg Total Time " << total_time.count() / num << " seconds.";
...
void bench_for_int_random(int num)
{
    ...
    int *p = (int *)malloc(n);
    std::vector idx1 = getIndexArray(num);
    std::chrono::high_resolution_clock::time_point t1 = std::chrono::high_resolution_clock::now();
    ...
    std::vector idx2 = getIndexArray(num);
